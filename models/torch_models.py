...
class TorchLinear(nn.Module):
    ...
    def __init__(self, in_features, out_features, bias=True, weight_init="kaiming", init_constant=1.0, bias_init="zeros"):
        super().__init__()
...
class TorchEmbedding(nn.Module):
    ...
    def __init__(self, num_embeddings, embedding_dim, weight_init="kaiming", init_constant=1.0):
        super().__init__()
...
class SwiGLUMlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features, weight_init="kaiming", weight_init_constant=1.0):
        super().__init__()
        self.in_features = in_features
